...
class Dual:
    ...
    def __iadd__(self, other):
        """
        Performs in-place addition (+=) with another dual number or a scalar.

        Args:

          other (Dual or scalar): The other dual number or scalar to add.
    ...
    def __isub__(self, other):
        """
        Performs in-place subtraction (-=) with another dual number or a scalar.

        Args:

           other (Dual or scalar): The other dual number or scalar to subtract.
    ...
    def __imul__(self, other):
        """
        Performs in-place multiplication (``*=``) with another dual number or a scalar.

        Args:

           other (Dual or scalar): The other dual number or scalar to multiply.
    ...
    def __truediv__(self, other):
        ...
        Args:
            ...
            other (Dual or scalar): The divisor, which can be another `Dual` object or a scalar.
        ...
        Raises:
            ...
            ZeroDivisionError: If the real part of the divisor `other` is zero (for dual number division) or if `other` is zero (for scalar division).
    ...
    def __itruediv__(self, other):
        """
        Performs in-place division (/=) with another dual number or a scalar.

        Args:

           other (Dual or scalar): The other dual number or scalar to divide by.
        ...
        Raises:
           ...
           ZeroDivisionError: If the real part of the divisor is zero (for dual numbers) or the scalar divisor is equal to zero.
        """
        if isinstance(other, Dual):
            if other.real == 0:
    ...
    def __neg__(self):
        """
        Performs unary negation (-) on the dual number.

        Returns:

           Dual: A new dual number with both the real and dual parts negated, such that x + (-x) = 0.
        """
    ...
    def pow(self, n):
        ...
        For a dual number `x = a + bε` and an integer power `n`, the power is defined as:
        ...
        Raises:
           ...
           ZeroDivisionError: If the operation is undefined due to:
    ...
    def __ipow__(self, other):
        """
        Performs in-place exponentiation (``**=``) for dual numbers.
    ...
    def __eq__(self, other):
        ...
        - Two dual numbers `x1 = a + bε` and `x2 = c + dε` are equal if and only if:
          their real parts are equal and their dual parts are equal: `a == c` and `b == d`.
